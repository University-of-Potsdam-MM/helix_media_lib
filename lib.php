...
if ($CFG->version >= 2012061800)
 require_once($CFG->dirroot."/repository/helix_media_lib/lib23.php");
else
 require_once($CFG->dirroot."/repository/helix_media_lib/lib20.php");

class repository_helix_media_lib extends repository_helix_media_lib_abs
{
 /**
 * Contructor function.
 ...
 **/
 ...
 {
  return array('api_url', 'http_host', 'vstream_url', 'astream_url', 'v_height', 'v_width');
 }
 ...
 **/
 ...
 public static function instance_config_form_real($mform)
 {
